...
namespace LP_Parameters.Commands
{
    ...
    public partial class CatParametersValues_Form : Form
    {
        Document _doc;

        public CatParametersValues_Form(Document doc)
        {
            InitializeComponent();
            _doc = doc;
            ...
            IEnumerable<ParameterElement> allParameters = new FilteredElementCollector(_doc)
                 ...
                 .Where(x => x is SharedParameterElement/* && x.Name.Contains("param")*/)
                 ;
            ...
            TextBox tbx3(int i) //Parameter Value
            {
                TextBox b = new TextBox();
                b.Name = "tbx3" + i.ToString();
                //b.Width = groupBox1.Size.Width / 3;
                ////b.Width = 60;            
                //b.Height = 60;
                b.Text = "Parameter Value";
                b.Size = new Size(200, 30);
                b.Anchor = (AnchorStyles.Left | AnchorStyles.Right);
                //b.Click += SetBtn_Click;
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                flowLayoutPanel1.Controls.Add(tbx3(i));
            }
        }
...

        {
            ...
            {
                if (control.Name.Contains("cmbox1"))
                {
...

        {
            ...
            foreach (Control control in flowLayoutPanel1.Controls.OfType<Control>())
            {
                if (control.Name.Contains("tbx3"))
                {
                    parametersvalue.Add(control.Text);
                }
            }
        ...
        //private void cmbox1_DropDown(object sender, EventArgs e)
        //{
        //    List<String> catselected = new List<String>();
        //    foreach (object itemChecked in checkedListBox1.CheckedItems)
        //    {
        ...
        private void PlusBtn_Click(object sender, EventArgs e)
        {
            ...
            flowLayoutPanel1.Controls.Add(cmbox1(n));
            flowLayoutPanel1.Controls.Add(tbx3(n));
        }
